...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-e1
echo     https://github.com/tfynes-pivotal/tap-gitops-e1
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-e1 --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-e1
git branch -M main
